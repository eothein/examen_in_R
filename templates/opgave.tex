...
%% headings
\markboth{\textnormal{\bf \large Naam examen: \myID}}%
{\textnormal{\bf \large Naam Examen: \myID}}
...
\begin{document}
	...
	\thispagestyle{empty}
	{\sf
		\textbf{\LARGE{Hogeschool Gent}}
		
		\textbf{\large{Naam examen \myDate \hfill Examen ID \myID}}
